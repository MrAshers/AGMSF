                        ...
                        if item != man_data_dic['mainactivity']:
                            if is_perm_exist:
                                ...
                                if prot_level_exist:
                                    if protlevel == 'normal':
                                        ret_list.append(
                                            ('exported_protected_permission_normal', (itemname, item, perm + prot),
                                             (an_or_a, itemname)))
                                        if itemname in ['Activity', 'Activity-Alias']:
                                        ...
                                        ret_list.append(
                                            ('exported_protected_permission_dangerous', (itemname, item, perm + prot),
                                             (an_or_a, itemname)))
                                        if itemname in ['Activity', 'Activity-Alias']:
                                            exported.append(item)
                                        exp_count[cnt_id] = exp_count[
                                        ...
                                        ret_list.append(
                                            ('exported_protected_permission_signature', (itemname, item, perm + prot),
                                             (an_or_a, itemname)))
                                    elif protlevel == 'signatureOrSystem':
                                        ret_list.append(
                                            ('exported_protected_permission_signatureorsystem',
                                             (itemname, item, perm + prot), (an_or_a, itemname)))
                                else:
                                    ret_list.append(
                                        ('exported_protected_permission_not_defined', (itemname, item, perm),
                                         (an_or_a, itemname)))
                                    if itemname in ['Activity', 'Activity-Alias']:
                                        exported.append(item)
                                ...
                                # defined in the analysed application.
                                    ...
                                    if prot_level_exist:
                                        if protlevel == 'normal':
                                            ...
                                            ret_list.append(
                                                ('exported_protected_permission', (itemname, item, perm + prot),
                                                 (an_or_a, itemname)))
                                        elif protlevel == 'signatureOrSystem':
                                            ret_list.append(
                                        ...
                                        ret_list.append(
                                            ('exported_protected_permission_app_level', (itemname, item, perm),
                                             (an_or_a, itemname)))
                                        if itemname in ['Activity', 'Activity-Alias']:
                                            exported.append(item)
                                        exp_count[cnt_id] = exp_count[
                        ...
                        if is_inf:
                            ...
                            if item != man_data_dic['mainactivity']:
                                if is_perm_exist:
                                    ...
                                    if perm_appl_level_exists is False:
                                        ret_list.append(
                                            ('exported_intent_filter_exists', (itemname, item),
                                ...
                                if itemname == 'Content Provider' and int(
                                    ...
                                    if is_perm_exist:
                                        ...
                                        if prot_level_exist:
                                            if protlevel == 'normal':
                                                ret_list.append(
                                                    ('exported_provider_normal', (itemname, item, perm + prot),
                                                     (an_or_a, itemname)))
                                                exp_count[cnt_id] = exp_count[
                                                                        cnt_id] + 1
                                            elif protlevel == 'dangerous':
                                                ret_list.append(
                                                    ('exported_provider_danger', (itemname, item, perm + prot),
                                                     (an_or_a, itemname)))
                                                exp_count[cnt_id] = exp_count[
                                                                        cnt_id] + 1
                                            elif protlevel == 'signature':
                                                ret_list.append(
                                                    ('exported_provider_signature', (itemname, item, perm + prot),
                                                     (an_or_a, itemname)))
                                            elif protlevel == 'signatureOrSystem':
                                                ret_list.append(
                                            ...
                                            ret_list.append(
                                                ('exported_provider_unknown', (itemname, item, perm),
                                                 (an_or_a, itemname)))
                                            exp_count[cnt_id] = exp_count[
                                                                    cnt_id] + 1
                                    else:
                                        if perm_appl_level_exists is False:
                                            ...
                                            if prot_level_exist:
                                                if protlevel == 'normal':
                                                    ret_list.append(
                                                        ('exported_provider_normal_app', (itemname, item, perm + prot),
                                                         (an_or_a, itemname)))
                                                    exp_count[cnt_id] = exp_count[
                                                                            cnt_id] + 1
                                                elif protlevel == 'dangerous':
                                                    ret_list.append(
                                                        ('exported_provider_danger_appl', (itemname, item, perm + prot),
                                                         (an_or_a, itemname)))
                                                    exp_count[cnt_id] = exp_count[
                                                                            cnt_id] + 1
                                                elif protlevel == 'signature':
                                                ...
                                                ret_list.append(
                                                    ('exported_provider_unknown_app', (itemname, item, perm),
                                                     (an_or_a, itemname)))
                                                exp_count[cnt_id] = exp_count[
                                                                        cnt_id] + 1
                                    ...
                                    if itemname == 'Content Provider' and int(man_data_dic['target_sdk']) >= 17:
                                        ...
                                        if is_perm_exist:
                                            ...
                                            if prot_level_exist:
                                                if protlevel == 'normal':
                                                    ret_list.append(
                                                        ('exported_provider_normal_new', (itemname, item, perm + prot),
                                                         (itemname)))
                                                    exp_count[cnt_id] = exp_count[
                                                                            cnt_id] + 1
                                                if protlevel == 'dangerous':
                                                    ret_list.append(
                                                        ('exported_provider_danger_new', (itemname, item, perm + prot),
                                                         (itemname)))
                                                    exp_count[cnt_id] = exp_count[
                                                                            cnt_id] + 1
                                                if protlevel == 'signature':
                                                    ret_list.append(
                                                        ('exported_provider_signature_new',
                                                         (itemname, item, perm + prot), (itemname)))
                                                ...
                                                ret_list.append(
                                                    ('exported_provider_unknown_new', (itemname, item, perm),
                                                     (itemname)))
                                                exp_count[cnt_id] = exp_count[
                                                                        cnt_id] + 1
                                        else:
                                            if perm_appl_level_exists is False:
                                                ...
                                                if prot_level_exist:
                                                    ...
                                                    ret_list.append(
                                                        ('exported_provider_unknown_app_new', (itemname, item, perm),
                                                         (an_or_a, itemname)))
                                                    exp_count[cnt_id] = exp_count[
                                                                            cnt_id] + 1
