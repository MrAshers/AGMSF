...
iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"第 1 页",sLast:"最后 1 页",sNext:"下一页",sPrevious:"上一页"},sEmptyTable:"数据为空",sInfo:"显示第 _START_ 项到第 _END_ 项 共 _TOTAL_ 项",sInfoEmpty:"共 0 项",sInfoFiltered:"(从共 _MAX_ 项中筛选)",sInfoPostFix:"",sDecimal:"",
sThousands:",",sLengthMenu:"共 _MENU_ 项",sLoadingRecords:"加载中...",sProcessing:"加工中...",sSearch:"搜索:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"没有匹配的结果"},oSearch:h.extend({},n.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};$(n.defaults);n.defaults.column={aDataSort:null,iDataSort:-1,asSorting:["asc",
